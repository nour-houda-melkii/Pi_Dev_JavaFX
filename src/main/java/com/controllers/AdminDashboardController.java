...
public class AdminDashboardController {
    ...
    private void openEditForm(Produit product) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/views/nour/edit_product.fxml"));
            Parent root = loader.load();
    ...
    private void handleFrontView() {
        try {
            URL resourceUrl = getClass().getResource("/com/views/nour/product_client.fxml");
    ...
    private void handleStatistics() {
        try {
            URL resourceUrl = getClass().getResource("/com/views/nour/statistics_view.fxml");
    ...
    private void handleDataHistory() {
        try {
            URL resourceUrl = getClass().getResource("/com/views/nour/data_history_view.fxml");
    ...
    private void handleViewCategories() {
        try {
            ...
            URL resourceUrl = getClass().getResource("/com/views/nour/view_categories.fxml");
    ...
    private void handleAddCategory() {
        try {
            URL resourceUrl = getClass().getResource("/com/views/nour/add_category.fxml");
    ...
    private void handleFavoritesStatistics() {
        try {
            URL resourceUrl = getClass().getResource("/com/views/nour/top_favorites_statistics.fxml");
