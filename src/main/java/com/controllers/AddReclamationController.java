...
public class AddReclamationController {
    ...
    public void initialize() {
        try {
            ...
            // Lors de l'initialisation des ComboBox, utiliser un StringConverter pour afficher uniquement le nom
            // Exemple pour typeComboBox :
            ...
            // Pour medecinComboBox :
            medecinComboBox.setConverter(new javafx.util.StringConverter<User>() {
                @Override
                public String toString(User user) {
                    return user != null ? user.getFirstName() + (user.getLastName() != null ? " " + user.getLastName() : "") : "";
                }
                @Override
    ...
    private void initializeMedecinComboBox() {
        try {
            List<User> medecinsList = userService.rechercherTousMedecins();
            ObservableList<User> medecins = FXCollections.observableArrayList();
            medecins.addAll(medecinsList);
    ...
    private void generateDescription() {
        ...
        if (selectedType != null && !selectedType.getNom().isEmpty()) {
            descriptionField.setText("Description par défaut pour: " + selectedType.getNom());
        }
    }
    ...
    private void addReclamation() {
        ...
        try {
            ...
            String typeName = selectedType.getNom();
            String medecinName = selectedMedecin.getFirstName() + (selectedMedecin.getLastName() != null ? " " + selectedMedecin.getLastName() : "");
    ...
    private void initializeComboBoxes() {
        try {
            ...
            ObservableList<TypeReclamation> types = FXCollections.observableArrayList(typesList);
