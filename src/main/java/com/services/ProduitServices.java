...
import static com.services.PaymentService.LOGGER;
...
public class ProduitServices {
    ...
    public int insert(Produit produit) throws SQLException {
        ...
        try (PreparedStatement ps = connection.prepareStatement(query, Statement.RETURN_GENERATED_KEYS)) {
            ...
            ps.setString(3, produit.getDesciption());
    ...
    public List<Produit> showAll() throws SQLException {
        ...
        try (Statement statement = connection.createStatement();
            ...
            while (resultSet.next()) {
                ...
                produit.setDesciption(resultSet.getString("desciption"));
    ...
    public Produit showById(int productId) {
        return null;
    }
    ...
    public int getProductQuantity(int productId) throws SQLException {
        int quantity = 0;
        String query = "SELECT quantity FROM produit WHERE id = ?";
        ...
        try (PreparedStatement pst = connection.prepareStatement(query)) {
            ...
            LOGGER.log(Level.SEVERE, "Error getting product quantity: " + e.getMessage(), e);
            throw e;
        }
